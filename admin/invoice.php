 ...
 */
 //BMH 2023-01-24   ln74 Tax Invoice Title "TITLE_INVOICE";
//                  ln105 class changes class td-lh  to force lh cell width for folding invoice
...
$img_width = defined('IMAGE_ON_INVOICE_IMAGE_WIDTH') ? (int)IMAGE_ON_INVOICE_IMAGE_WIDTH : '50';
  ...
  <body>
    <div class="container">
      ...
      <table class="table-invoice">
        <tr>
          <td class="pageHeadingL"><?php echo nl2br(STORE_NAME_ADDRESS); ?></td>
      ...
      <table class="table">
         ...
         // if ($show_customer == true) {
          ...
          <tr>
          <td class="main-address1" colspan="2"><?php //echo zen_address_format($order->customer['format_id'], $order->customer, 1, '', '<br>'); ?></td> </tr>
        <?php //} ?>
         BMH eof -->
        <tr>
          <td class="td-lh">
            <table class="address_table"> <!-- BMH added class -->
              <tr> <td class="main-address1"><b><?php echo ENTRY_SOLD_TO; ?></b></td> </tr>
              <tr>  <td class="main-address1"><?php echo zen_address_format($order->billing['format_id'], $order->billing, 1, '', '<br>'); ?></td> </tr>
              <tr> <td><?php echo zen_draw_separator('pixel_trans.gif', '1', '5'); ?></td> </tr>
              <tr> <td class="main-address1"> <?php echo ENTRY_TELEPHONE_NUMBER . ' ' . $order->customer['telephone']; ?> </td> </tr>
              <tr> <td class="main"><?php echo '<a href="mailto:' . $order->customer['email_address'] . '">' . $order->customer['email_address'] . '</a>'; ?></td> </tr>
            </table>
          </td>
        ...
        <?php
          if ($show_customer == true) {
            ?>
          <tr> <td class="main-address1" colspan="2"><b><?php echo ENTRY_CUSTOMER; ?></b></td>  </tr>
          <tr> <td class="main-address1" colspan="2"><?php echo zen_address_format($order->customer['format_id'], $order->customer, 1, '', '<br>'); ?></td>  </tr>
        <?php } ?>
...
?>
        ...
        <tbody>
            ...
            <tr class="dataTableRow">
              <?php if ($show_product_images) {  ?>
              <td class="dataTableContentzz">  <!-- //BMH class dataTableContent to dataTableContentzz -->
...
?>
      ...
      <?php if (ORDER_COMMENTS_INVOICE > 0) { ?>
        <table class="table table-condensed" style="width:50%;"> <!-- BMH 100% to 50% -->
          <thead>
            <tr>
